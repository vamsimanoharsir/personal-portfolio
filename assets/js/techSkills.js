const techSkills = [
  {
    ...
    skills: [
      ...
      {
        icon: `<i class="fa-brands fa-php fa-sm text-red-600"></i>`,
        name: "PHP",
        label: "Junior",
      },
      {
        icon: `<i class="fa-brands fa-markdown fa-2xs text-slate-600"></i>`,
        name: "Markdown",
        label: "Junior",
      },
    ],
  },
  {
    ...
    skills: [
      ...
      {
        icon: `<i class="fa-solid fa-code fa-xs text-green-600"></i>`,
        name: "Tailwind",
        label: "Expert",
      },
      {
